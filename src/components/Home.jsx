...
import { Grid, Flex, SocialMedia, MarqueeText } from "../styles/globalStyles.js"
import { OtherPage, Main, Container } from "../styles/homeStyles.js"

export const Home = ({ onCursor }) => {
  return (
    <>
      <Container onMouseEnter={onCursor}>
        <Grid frame={"2fr 1fr"}>
          <Main>
            <h1
            ...
            <p>
              ...
              <br /> Who passionate to build great things for website
            </p>
          </Main>
          <Flex borderLeft direction={"column"}>
            <SocialMedia borderbtm="true">
              <a
